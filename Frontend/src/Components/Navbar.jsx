...
const Navbar = () => {
  ...
  const navItems = (
    <>
      ...
      <li key="about"><a>About</a></li>
    </>
  );

  return (
    <div
      className={`max-w-full container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0  z-50 ${
        sticky
    ...
    >
      <div className="navbar ">
        <div className="navbar-start">
          ...
          <a href="/" className="text-2xl font-bold cursor-pointer">BookHub</a>
        </div>
